...
[
  {
    ...
    "options": [
      ...
      {"label": "Use reference benchmarks", "description": "Score against reference benchmarks (1,872 avg engagement, 500 posts analysed). Good fallback."},
...
Data source: [their posts / reference benchmarks / generic]
...
Use these reference benchmarks as the scoring baseline when the user picks "Use reference benchmarks" and no cached file is found:
