...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  .use h2 {
    margin:0 0 4px; font-family:Archivo,sans-serif; font-size:15px;
    letter-spacing:-.01em; font-weight:700;
  }
  .use p { margin:8px 0 0; color:var(--ink-2); max-width:72ch; }
  .use code {
    background:var(--paper); border:1px solid var(--rule); border-radius:4px;
    padding:1px 5px; font-size:12.5px;
  }
  .use pre {
    margin:10px 0 0; padding:11px 13px; background:var(--paper);
    border:1px solid var(--rule); border-radius:7px; overflow-x:auto;
  }
  .use pre code { background:none; border:none; padding:0; }
  .use .steps { display:flex; flex-wrap:wrap; gap:22px; margin-top:14px; }
  .use .step { flex:1 1 240px; min-width:0; }
  .use .step b {
  ...
  .demos { margin-top:18px; padding-top:16px; border-top:1px solid var(--rule); }
  .demos b {
    display:block; font-family:Archivo,sans-serif; font-size:12px; text-transform:uppercase;
    letter-spacing:.07em; color:var(--ink-3); margin-bottom:10px;
  }
  .demo-grid { display:flex; flex-wrap:wrap; gap:14px; }
  .demo { flex:1 1 240px; min-width:0; }
  .demo video {
    width:100%; display:block; border:1px solid var(--rule); border-radius:8px;
    background:var(--paper); cursor:pointer;
  }
  .demo span { display:block; margin-top:6px; font-size:12.5px; color:var(--ink-2); }
  ...
  <section class="use">
    ...
    <div class="steps">
      ...
      <div class="step">
        <b>3 · Ask</b>
        <p>
          Skills load themselves when a request matches. Name one directly —
          <code>/finance:cost-accounting</code> — when you want a specific lens instead.
        </p>
      </div>
    </div>
    <div class="demos">
      ...
      <div class="demo-grid">
        <div class="demo">
          <video src="assets/demo/headcount-install.mp4" poster="assets/demo/poster-install.jpg"
                 controls preload="none" playsinline muted loop></video>
          <span>Installing three departments</span>
        </div>
        <div class="demo">
          <video src="assets/demo/headcount-usage.mp4" poster="assets/demo/poster-usage.jpg"
                 controls preload="none" playsinline muted loop></video>
          <span>A leaver who still had access</span>
        </div>
        <div class="demo">
          <video src="assets/demo/headcount-marketing.mp4" poster="assets/demo/poster-marketing.jpg"
                 controls preload="none" playsinline muted loop></video>
          <span>Updating an old blog post</span>
        </div>
      </div>
    </div>
    <p class="links">
