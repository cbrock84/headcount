...
The single owner of `plugins/pmo/**`. No other agent writes inside this surface, so every change
...
- No change outside `plugins/pmo/**`. Needing one means coordinating with that surface's owner.
